...
> extends H<D, PC, H2<D, PC>, H2__<D, PC>, H2_c<D, PC>> {

	public H2(D document, PC pc) {
		super(document, pc);
	}

	@Override
	protected H2<D, PC> writeOpen(Writer out) throws IOException {
	...
	@Override
	protected H2__<D, PC> new__() {
		return new H2__<>(this);
	}

	@Override
	protected H2_c<D, PC> new_c() {
