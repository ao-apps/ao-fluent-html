 ...
 */
public class H2<PC extends Content> extends Element<H2<PC>> implements
	...
	Attributes.Event.AlmostGlobal<H2<PC>>
{
	 ...
	 */
	public <Ex extends Throwable> PC __(RunnableE<Ex> h2) throws IOException, Ex {
		if(h2 != null) {
			document.out.write('>');
			h2.run();
			document.out.write("</h2>");
	 ...
	 * @return  The parent content model this element is within
	 */
	public <Ex extends Throwable, PContent extends PhrasingContent<PContent>> PC __(ConsumerE<? super PContent, Ex> h2) throws IOException, Ex {
		if(h2 != null) {
			document.out.write('>');
