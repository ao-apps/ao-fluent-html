	...
	Attributes.Event.AlmostGlobal<H4<PC>>
{
	 ...
	 */
	public <Ex extends Throwable> PC __(RunnableE<Ex> h4) throws IOException, Ex {
		if(h4 != null) {
			document.out.write('>');
			h4.run();
			document.out.write("</h4>");
	 ...
	 * @return  The parent content model this element is within
	 */
	public <Ex extends Throwable, PContent extends PhrasingContent<PContent>> PC __(ConsumerE<? super PContent, Ex> h4) throws IOException, Ex {
		if(h4 != null) {
			document.out.write('>');
