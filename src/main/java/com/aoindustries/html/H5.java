	...
	Attributes.Event.AlmostGlobal<H5<PC>>
{
	 ...
	 */
	public <Ex extends Throwable> PC __(RunnableE<Ex> h5) throws IOException, Ex {
		if(h5 != null) {
			document.out.write('>');
			h5.run();
			document.out.write("</h5>");
	 ...
	 * @return  The parent content model this element is within
	 */
	public <Ex extends Throwable, PContent extends PhrasingContent<PContent>> PC __(ConsumerE<? super PContent, Ex> h5) throws IOException, Ex {
		if(h5 != null) {
			document.out.write('>');
