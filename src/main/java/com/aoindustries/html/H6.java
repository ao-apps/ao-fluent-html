	...
	Attributes.Event.AlmostGlobal<H6<PC>>
{
	 ...
	 */
	public <Ex extends Throwable> PC __(RunnableE<Ex> h6) throws IOException, Ex {
		if(h6 != null) {
			document.out.write('>');
			h6.run();
			document.out.write("</h6>");
	 ...
	 * @return  The parent content model this element is within
	 */
	public <Ex extends Throwable, PContent extends PhrasingContent<PContent>> PC __(ConsumerE<? super PContent, Ex> h6) throws IOException, Ex {
		if(h6 != null) {
			document.out.write('>');
