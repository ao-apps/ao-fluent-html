...
> extends Void<D, PC, E> implements
	com.aoindustries.html.any.attributes.Enum.Charset<E, com.aoindustries.html.any.attributes.Enum.Charset.Value>,
	com.aoindustries.html.any.attributes.Text.Content<E>,
	com.aoindustries.html.any.attributes.Enum.HttpEquiv<E, AnyMETA.HttpEquiv>,
	com.aoindustries.html.any.attributes.Enum.Name<E, AnyMETA.Name>
	// TODO: scheme
	...
	// Not on <meta>: AlmostGlobalAttributes<E>
{
	...
	public enum HttpEquiv implements Function<AnyDocument<?>, String> {
		 ...
		 *
		 * @deprecated  Do not use this value, as it is obsolete. Use the {@link com.aoindustries.html.any.attributes.Enum.Charset charset}
		 ...
		 *   - only if the {@link com.aoindustries.html.any.attributes.Text.Content content} attribute contains a positive integer.
		 * </li>
		 * <li>
		 *   The number of seconds until the page should redirect to another
		 *   - only if the {@link com.aoindustries.html.any.attributes.Text.Content content} attribute contains a
