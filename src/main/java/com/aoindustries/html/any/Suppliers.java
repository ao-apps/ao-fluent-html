...
public class Suppliers {
	...
	/**
	 * Variant bounded by {@link com.aoindustries.html.any.Circle}, since can't have multiple methods with different bounds due to erasure.
	 *
	 * @param  <Ex>  An arbitrary exception type that may be thrown
	 */
	@FunctionalInterface
	public interface Circle<Ex extends Throwable> extends IOSupplierE<com.aoindustries.html.any.Circle, Ex> {

		/**
		 * @return  The attribute value or {@code null} for no attribute.
		 */
		@Override
		com.aoindustries.html.any.Circle get() throws IOException, Ex;
	}
